...
set(MPLABX_INSTALL_DIR "" CACHE PATH "Path to root of MPLAB X IDE (optional)")
...
# 最新版を取得
file(GLOB MPLAB_X_VARIANTS ${MPLABX_INSTALL_DIR}/v*)
list(SORT MPLAB_X_VARIANTS ORDER DESCENDING)
list(GET MPLAB_X_VARIANTS 0 MPLABX_ROOT)
